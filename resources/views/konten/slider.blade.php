                          ...
                          <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$no++}}</td>
                                    <td>{{$dt['judul']}}</td>        
                                    <td><img src="assets/img/slider/small-{{$dt['gambar']}}" style="width:100px; height:100px;" alt=""></td>
                                    <td>{{$dt['deskripsi']}}</td>
                                    <td><button class="btn btn-warning"><i class="fa-solid fa-edit"></i></button> | <button class="btn btn-danger"><i class="fa-solid fa-trash"></i></button> | <button class="btn btn-info"><i class="fa-solid fa-eye"></i></button></td>
                                </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
