...
<head>
    ...
    <title>LABSIMPOLTEKBANG | Kuisioner</title>
                        ...
                        <a href="/tambahpertanyaan" class="btn btn-primary mb-3">Tambah</a>
                          <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$dt['pertanyaan']}}</td>
                                    <td style="width: 80px;"><button class="btn btn-warning"><i class="fa-solid fa-edit"></i></button> | <button class="btn btn-danger"><i class="fa-solid fa-trash"></i></button></td>
                                </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
